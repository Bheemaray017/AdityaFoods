...
if (isset($_SESSION['alogin'])) {
    ...
    // Get registration ID based on email
    ...
    // View new received orders
    $viewprod = "SELECT * 
        FROM tbl_customer_order, tbl_customer_delv_address, tbl_product, tbl_registration 
    ...
    // Corrected SQL query with JOIN between login and registration using email
